...
function car1_up() { if(car1Y >=0) { car1Y = car1Y - 10; console.log("Quando a seta para cima é pressionada, x = " + car1X + " | y = " +car1Y); uploadBackground(); uploadcar1(); uploadcar2(); } }




function car1_down() { if(car1Y <=500) { car1Y = car1Y + 10; console.log("Quando a seta para baixo é pressionada, x = " + car1X + " | y = " +car1Y); uploadBackground(); uploadcar1(); uploadcar2(); } }



function car1_left() { if(car1Y >=0) { car1Y = car1Y - 10; console.log("Quando a seta para esquerda é pressionada, x = " + car1X + " | y = " +car1Y); uploadBackground(); uploadcar1(); uploadcar2(); } }




function car1_right () { if(car1Y <=700) { car1Y = car1Y + 10; console.log("Quando a seta para direita é pressionada, x = " + car1X + " | y = " +car1Y); uploadBackground(); uploadcar1(); uploadcar2(); } }